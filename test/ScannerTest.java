...
public class ScannerTest {
    ...
    public void next() throws Exception {
        ...
        scanner.next();
        assertTrue(scanner.tok==Scanner.ARROW_TOK);
        scanner.next();
        assertTrue(scanner.tok==Scanner.OF_TYPE_TOK);
        scanner.next();
        ...
        scanner.next();
        assertTrue(scanner.tok==Scanner.EMPTY_LIST_TOK);
        scanner.next();
...
//        assertTrue(scanner.tok==Scanner.DOT_TOK);
        ...
        scanner. next();
        assertTrue(scanner.tok==Scanner.EQ_TOK);
        scanner. next();
        assertTrue(scanner.tok==Scanner.LT_TOK);
        scanner.  next();
        assertTrue(scanner.tok==Scanner.GT_TOK);
        scanner.  next();
        assertTrue(scanner.tok==Scanner.LE_TOK);
        scanner.   next();
        assertTrue(scanner.tok==Scanner.GE_TOK);
        scanner.  next();
        assertTrue(scanner.tok==Scanner.NE_TOK);
        scanner. next();
